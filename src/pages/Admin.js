    ...
    return (
        <div style={{marginTop: '20px'}}> 
           ...
           {data.map(record => {
               return(
                   <div key={record._id }>
                   <ListGroupItem color="success"> <p>{record.description} <a href={record.url} target="_blank">link</a> <Button onClick={() => handleDelete(record._id)} color="danger" style={{float: 'right'}}>Delete</Button></p>
                   </ListGroupItem>
                    </div>
               )
        ...
        <form >
            ...
            <div className="form-group">
                ...
                <input type="text" className="form-control" placeholder="Enter Description" onChange={(e) => {
            ...
            <div className="form-group">
                <label>URL</label>
                <input type="text" className="form-control" placeholder="Enter URL" onChange={(e) => {
